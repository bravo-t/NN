...
int main() {
    ...
    convnet_params->M = 4;
    convnet_params->N = 1;
    int stride[4] = {1, 1,2,2};
    int filter_size[4] = {5,5,4,3};
    int filter_number[4] = {16,16,16,16};
    bool enable_maxpooling[4] = {false, false, false, false};
    int maxpooling_stride[4] = {2,2,3};
    int maxpooling_size[4] = {2,2,3};
