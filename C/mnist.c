...
int main() {
    ...
    convnet_params->number_of_samples = 60;
    //convnet_params->number_of_samples = number_of_batch_data*10000;
    convnet_params->M = 3;
    convnet_params->N = 1;
    int stride[3] = {1, 2,2};
    int filter_size[3] = {8,5,5};
    int filter_number[3] = {3,5,5};
    bool enable_maxpooling[3] = {false, false, false};
    int maxpooling_stride[3] = {2,3,3};
    int maxpooling_size[3] = {2,3,3};
    int padding[3] = {0,0,0};
    ...
    convnet_params->learning_rate_decay_unit = 150;
