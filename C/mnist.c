...
int main() {
    ...
    convnet_params->number_of_samples = 50;
    //convnet_params->number_of_samples = number_of_batch_data*10000;
    convnet_params->M = 2;
    convnet_params->N = 1;
    int stride[4] = {1, 1};
    int filter_size[4] = {5,5};
    int filter_number[4] = {8,16};
    bool enable_maxpooling[4] = {true, true};
    int maxpooling_stride[4] = {2,3};
    int maxpooling_size[4] = {2,3};
    int padding[4] = {0,2};
