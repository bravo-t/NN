...
int main() {
    ...
    convnet_params->number_of_samples = 20;
    convnet_params->minibatch_size = 20;
    //convnet_params->number_of_samples = number_of_batch_data*10000;
    convnet_params->M = 2;
    convnet_params->N = 1;
    int stride[2] = {1,1};
    int filter_size[2] = {5,5};
    int filter_number[2] = {8,16};
    bool enable_maxpooling[2] = {true,true};
    int maxpooling_stride[2] = {2,3};
    int maxpooling_size[2] = {2,3};
    int padding[2] = {0,2};
